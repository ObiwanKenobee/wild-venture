...
import { ArrowRight, MapPin, Users, Zap, TreePine, Heart, Star, Calendar, Globe } from "lucide-react"
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <p className="text-xl lg:text-2xl mb-8 text-green-50 max-w-3xl mx-auto">
              ...
              communities, and use technology to protect our environment.
            </p>
